<template>
    <div class="container">
        ...
        <div class="warning-box">
            <p><strong>Advertencia:</strong> Esta acción no se puede deshacer. Eliminar un estudiante lo borrará
                permanentemente de la base de datos.</p>
        </div>
...
<script>
import { consutarPorIDFachada, eliminarFachada } from '@/clients/matricula.js';
...
export default {
    ...
    methods: {
        ...
        async eliminar() {
            ...
            const confirmacion = confirm(`¿Realmente deseas eliminar al estudiante ${this.estudiante.nombre} ${this.estudiante.apellido}? Esta acción no se puede deshacer.`);
